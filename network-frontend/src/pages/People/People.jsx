...
<div className="p-4 px-10 border-1 border-gray-400 w-full flex justify-between my-5 text-xl bg-white rounded-xl">
    ...
    <div className='flex gap-3'>
        <div onClick={handleConnect}className={`p-1 border-1 rounded-lg border-gray-300 cursor-pointer ${text==='Engage in professional networking'?'bg-blue-900 text-white':""}`}>Connections</div>
        <div onClick={handleReq}className={`p-1 border-1 rounded-lg border-gray-300 cursor-pointer ${text==="Pending Requests"?"bg-blue-900 text-white":""}`}>Pending Requests</div>
